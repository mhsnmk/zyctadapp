    ...
    <div className={classes.grow}>
      ...
      >
        <Toolbar className={classes.sectionDesktop}>
          ...
          >
            {" "}
            <img alt="logo" src="img/logo-white.png" className={classes.logo} />
            <span className={classes.spanLogoText}>Zycta-</span>Finance
          </a>
          ...
          <div>
            <a href="/launchpad" className={classes.navbarItemsDesktop}>
              Launchpad
            </a>
          </div>
